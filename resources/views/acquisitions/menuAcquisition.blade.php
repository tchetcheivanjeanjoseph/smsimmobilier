                ...
                <div class="flex items-stretch justify-center">
                    <div class="relative inline-block text-left dropdown">
                        ...
                        <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none" aria-labelledby="headlessui-menu-button-1" id="headlessui-menu-items-117" role="menu">
                            <div class="py-1">
                                <a href="/locations/listeContrats" class="flex justify-between w-full px-4 py-2 text-sm leading-5 text-left text-gray-700"  role="menuitem" >Toutes les acquisitions</a>
                                <a href="/locations/locatairesAJour"  class="flex justify-between w-full px-4 py-2 text-sm leading-5 text-left text-gray-700"  role="menuitem" >Liste des dossiers en cours</a>
                                <a href="/locations/locatairesNonAJour"  class="flex justify-between w-full px-4 py-2 text-sm leading-5 text-left text-gray-700"  role="menuitem" >Liste des dossiers archiver</a>
                            </div>
                        </div>
                    </div>
                </div>              
