...
<div class="mt-10 sm:mt-0"> 
          ...
          <form method="POST" action="{{route('clients.updateClient',$client->id)}}" enctype="multipart/form-data">
            @csrf
              ...
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-2 md:col-span-2 sm:col-span-3">
                    ...
                    <input type="text" name="villeResidence" id="villeResidence" value={{$client->villeResidence}} class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                  ...
                  <div class="col-span-2 md:col-span-2 sm:col-span-3">
                    ...
                    <input type="text" name="paysResidence" id="paysResidence" value={{$client->paysResidence}} class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    @error('paysResidence')
