<div class="mt-10 sm:mt-0">
  <div class="">
    <div class="mt-5 md:mt-0 md:col-span-2">
      ...
      @endif
      <div>
        <p class="justify-center py-2 text-xl font-bold text-center text-indigo-500" >Nouvelle visite</p>
      </div>
      <form action="{{route('createVisite')}}" method="POST">
          ...
          <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
               <div class="col-span-2 md:col-span-2 sm:col-span-3">
                  ...
                  <input type="text" name="nom" id="nom" autocomplete="nom" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                  @error('nom')
                ...
                <div class="col-span-3 md:col-span-2 sm:col-span-3">
                  ...
                  <select name="genre" id="genre" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
              ...
              <div class="col-span-2 md:col-span-2 sm:col-span-3">
                ...
                <input type="date" name="dateVisite" id="dateVisite" autocomplete="date-visite" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                @error('dateVisite')
              ...
              <div class="col-span-2 md:col-span-2 sm:col-span-3">
                ...
                <input type="time" name="heureVisite" id="heureVisite" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                @error('heureVisite')
              ...
              <div class="col-span-6 md:col-span-2 sm:col-span-4">
                ...
                <input type="text" name="lieuRdv" id="lieuRdv" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                @error('lieuRdv')
              ...
              <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                ...
                <input type="text" name="lieuVisite" id="lieuVisite" autocomplete="lieu-visite" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                @error('lieuVisite')
        ...
        <div class="w-full px-4 py-6 text-center sm:px-6">
