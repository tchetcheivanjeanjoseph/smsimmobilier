<!--
 ...
 <div class="flex justify-between w-full place-content-center">
    
     <div>
      <p class="justify-center py-2 text-xl font-bold text-center text-indigo-500" >Nouvelle visite</p>
    </div>
    
     <div class="flex items-center bg-white rounded-full " x-data="{ search: '' }">
         <div class="w-full">
          ...
          <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
            <div class="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg">
              ...
              <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-900">{{$visite->dateVisite}}</div>
                  <div class="text-sm text-gray-500">{{$visite->heureVisite}}</div>
                </td>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-900">{{$visite->lieuVisite}}</div>
                  <div class="text-sm text-gray-500">{{$visite->lieuRdv}}</div>
                ...
                <td class="flex justify-center px-6 py-4 text-sm font-medium whitespace-nowrap">
                  ...
                  <a href="{{route('biens.deleteVisite', $visite->id)}}" class="px-2 text-red-600 hover:bg-red-400 hover:text-indigo-900">
                  ...
                  <a href="{{route('biens.editVisite', $visite->id)}}" class="px-2 text-indigo-600 hover:text-indigo-900">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
