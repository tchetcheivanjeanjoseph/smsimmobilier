<!--
 ...
 <div class="flex justify-between w-full place-content-center">
      <div>
        <p class="justify-center py-2 text-xl font-bold text-center text-indigo-500" >Liste des biens</p>
      </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  ...
                  <tr>
                    ...
                    <td class="flex justify-center px-6 py-4 text-sm font-medium whitespace-nowrap">
                      ...
                      <a href="{{route('biens.deleteBien', $bien->id)}}" class="px-2 text-red-600 ">
                      ...
                      <a href="{{route('biens.editBien', $bien->id)}}" class="px-2 text-indigo-600 ">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
