          ...
          <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="col-span-2 md:col-span-2 sm:col-span-3">
                ...
                <input type="text" name="prenomAcquereur" id="prenomAcquereur" autocomplete="prenomAcquereur" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
              ...
              <div class="col-span-6 md:col-span-2 sm:col-span-4">
                ...
                <input type="text" name="contact" id="contact" autocomplete="contact" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                @error('contact')
              ...
              <div class="col-span-6 md:col-span-2 sm:col-span-4">
                ...
                <input type="text" name="bien" id="bien" autocomplete="bien" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                @error('bien')
