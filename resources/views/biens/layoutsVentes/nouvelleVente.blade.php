...
<div class="w-full mt-10 sm:mt-0">
  <div class="">
    <div class="mt-5 md:mt-0 md:col-span-2">
          ...
          <div class="px-4 py-2 -mx-3">
              <div class="mx-3">
                <span class="font-semibold text-green-500 dark:text-green-400"
                  >Félicitation nouvelle vente enregistrée</span
                >
      ...
      @endif
      <form action="{{route('createVente')}}" method="POST" enctype="multipart/form-data">
        @csrf
          ...
          <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              <div class="col-span-2 md:col-span-2 sm:col-span-3">
                ...
                <input type="text" name="nomAcquereur" id="nomAcquereur" autocomplete="nomAcquereur" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                @error('nomAcquereur')
              ...
              <div class="col-span-2 md:col-span-2 sm:col-span-3">
                ...
                <input type="text" name="prenomAcquereur" id="prenomAcquereur" autocomplete="prenomAcquereur" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
              ...
              <div class="col-span-2 md:col-span-2 sm:col-span-3">
                ...
                <input type="email" name="email" id="email" autocomplete="email" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                @error('email')
              ...
              <div class="col-span-6 md:col-span-2 sm:col-span-4">
                ...
                <input type="number" name="valeur" id="valeur" autocomplete="valeur" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                @error('valeur')
              ...
              <div class="col-span-6 md:col-span-2 sm:col-span-4">
                ...
                <input type="text" name="bien" id="bien" autocomplete="bien" class="block w-full p-2 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                @error('bien')
